        ...
        <div className='w-full flex flex-col'>
          ...
          <div className='flex items-center gap-x-2 h-[36px] text-sm'>
            ...
            <div className='flex flex-1 items-center h-full border text-primary font-medium max-w-[100px]'>
              <div onClick={() => decrementQuantity(id)} className='flex-1 h-full flex justify-center items-center cursor-pointe'>
                <IoMdRemove />
              </div>
              {/*quantity*/}
              ...
              {/*icon plus*/}
              <div onClick={() => incrementQuantity(id)} className='flex-1 h-full flex justify-center items-center cursor-pointer'>
                <IoMdAdd />
              </div>
            </div>
            {/*price*/}
